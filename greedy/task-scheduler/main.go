...
func leastInterval(tasks []byte, n int) int {
	...
	// that, we try to optimise the total number of idle slots by subrating it based on the min(tast_freq, maxfreq-1). It is possible that
	...
	// Reset idle slots to zero if negative
